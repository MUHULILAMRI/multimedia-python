...
def manipulate_image(input_path, output_path):
    try:
        ...
        if image.width > 200 and image.height > 200:
            ...
            cropped_image.save('cropped1_' + output_path)
        ...
        combined_image.save('combined2_' + output_path)
...
if __name__ == "__main__":
    manipulate_image('image.png', 'task1.tugas.jpg')
